                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <View className='flex flex-row flex-wrap bg-neutral-800 p-5 rounded-xl'>
                            ...
                            <View className='basis-full flex-row'>
                                <Text className='text-white'>Calories: {food?.calories?.value}</Text>
                                <Text className='text-white'> Protein: {food?.protein?.value} {food?.protein?.unitName}</Text>
                                <Text className='text-white'> Fat: {food?.fat?.value} {food?.fat?.unitName}</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                </View>
