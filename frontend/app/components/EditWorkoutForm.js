            ...
            {(formikProps) => (
                <View>
                    <TextInput 
                        ...
                        className={`border m-2 mt-10 p-2 rounded text-base text-white text-center ${missingFields.includes("Workout Name") ? 'border-red-200': 'border-gray-300'}`}
                    />
                    ...
                    <TextInput 
                        ...
                        className={`border ml-2 mr-2 p-2 rounded text-base text-white text-center ${missingFields.includes("Sets") ? 'border-red-200': 'border-gray-300'}`}
                    />
                    ...
                    <TextInput 
                        ...
                        className={`border mt-2 ml-2 mr-2 p-2 rounded text-base text-white text-center ${missingFields.includes("Reps") ? 'border-red-200': 'border-gray-300'}`}
                    />
                    ...
                    <TextInput 
                        ...
                        className={`border m-2 p-2 rounded text-base text-white text-center ${missingFields.includes("Weight") ? 'border-red-200': 'border-gray-300'}`}
                    />
